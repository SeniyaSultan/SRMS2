...
const ProfileTeacher = () => {
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-[#b7dbed] rounded-lg shadow-lg relative space-y-6 text-black mb-8"> {/* Updated colors and added bottom margin */}
      <button
        className="absolute top-5 right-5 bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 transition duration-200 shadow-md"
      ...
      >
        <img
          src={uploadedImage}
          alt="Profile"
          className="w-32 h-32 rounded-full object-cover shadow-lg transition-transform duration-200 hover:scale-105"
        />
      </div>

      <label className="block text-center text-gray-800 mb-2">Upload Image</label>
      <label className="block text-center font-bold text-2xl text-blue-700 mb-6">Teacher Profile Page</label>
